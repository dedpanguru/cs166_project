...
4. If you launch through Docker, Backend will be running on http://host.docker.internal:8080, otherwise, it runs on http://0.0.0.0:8080 by default, so direct all http requests to those addresses
